...
**contact information**
→ you can send an email if you are really struggeling linked on my  [github profile]([https://developer.android.com/tools/releases/platform-tools](https://github.com/lkyuca))
